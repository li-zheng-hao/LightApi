...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddRpcClient<T>(
        this IServiceCollection services,
        Action<RpcOptions> options,
        ...
        where T : class
    {
        ...
        var builder = services
            .AddRefitClient<T>(rpcOptions.Settings)
            .ConfigureHttpClient(c =>
            {
                string url = rpcOptions.UseTls
                    ? $"https://{rpcOptions.Host}"
                    : $"http://{rpcOptions.Host}";
        ...
        if (rpcOptions.ServiceDiscoveryType == ServiceDiscoveryType.Nacos)
        {
            ...
            services.TryAddTransient<NacosServiceDiscoveryHandler>(sp =>
            {
                ...
                return new NacosServiceDiscoveryHandler(
                    rpcOptions,
