...
public class CustomEasyNetQSerialzer:ISerializer
{
   private static readonly Encoding Encoding = new UTF8Encoding(false);
    ...
    /// </summary>
    public CustomEasyNetQSerialzer()
    {
        ...
        // lizhenghao 使用项目全局配置
        object? serializerSettings=JsonConvert.DefaultSettings?.Invoke();
